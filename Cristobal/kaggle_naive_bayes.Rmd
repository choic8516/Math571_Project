...
adapted.df<-cbind(headlines.df[3:Nrows,c(1,2)],headlines.df[1:(Nrows-2),3:27],
                  headlines.df[2:(Nrows-1),3:27],headlines.df[3:(Nrows),3:27])
...
train.index<-c(1:1500)
test.index<-c(1501:1988)
