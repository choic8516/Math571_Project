...
scores <- read.xlsx("data/scores/nyt_headlines_2000_scored.xls", sheetIndex = 1,stringsAsFactors=FALSE)
sub_scores <- scores
...
colnames(final) <- c("Very Negative", "Negative", "Postive", "Very Positive", "Date")
