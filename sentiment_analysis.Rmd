...
for (year in c(1989:1994)){
        ...
        write.csv(data_sentiment,paste0("data/scores/nyt_headlines_",year,"_scored.csv"))
        ...
        colnames(heads.25)<-c("pub_date",paste0("headline.4",c(1:25)))
        colnames(scores.25)<-c("pub_date",paste0("headline.4",c(1:25)))
